...
namespace HotFix
{
	public class UIWheelSymbolItem : CustomBehaviour
	{
		...
		{
			this.rewardItem.RefreshRate(selectRate);
		}
		...
		public UIWheelRewardItem rewardItem;
		...
		private TurntableSymbolData data;
	}
}
