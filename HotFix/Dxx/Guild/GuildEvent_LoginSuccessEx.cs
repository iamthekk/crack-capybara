...
namespace Dxx.Guild
{
	public static class GuildEvent_LoginSuccessEx
	{
		public static void SetDataFromServer(this GuildEvent_LoginSuccess e, GuildDetailInfoDto detaildto, GuildFeaturesDto featuresdto)
		{
			e.MyGuildShareDetail = detaildto.ToGuildDetailData();
			...
			e.Boss = featuresdto.GuildBossInfo.ToGuildBossInfo();
			e.ApplyJoinCount = (int)featuresdto.ApplyCount;
			e.DayContributeTimes = (int)featuresdto.DayContributeTimes;
			e.DayAllContributeTimes = featuresdto.DayALLContributeTimes;
		}
	}
}
