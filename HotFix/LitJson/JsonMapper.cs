...
namespace LitJson
{
	public class JsonMapper
	{
		...
		private static object ReadValue(Type inst_type, JsonReader reader)
		{
			...
			{
				if (reader.Token != JsonToken.Double && reader.Token != JsonToken.Fp && reader.Token != JsonToken.Int && reader.Token != JsonToken.Long && reader.Token != JsonToken.String && reader.Token != JsonToken.Boolean)
				{
					object obj = null;
		...
		private static IJsonWrapper ReadValue(WrapperFactory factory, JsonReader reader)
		{
			...
			if (reader.Token == JsonToken.Fp)
			{
				jsonWrapper.SetFp((FP)reader.Value);
				return jsonWrapper;
			}
		...
		public static JsonData ToObjectFp(string json)
		{
			return (JsonData)JsonMapper.ToWrapperFp(() => new JsonData(), json);
		}
