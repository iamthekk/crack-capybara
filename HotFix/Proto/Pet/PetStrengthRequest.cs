...
namespace Proto.Pet
{
	public sealed class PetStrengthRequest : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<PetStrengthRequest> Parser
		{
			get
			{
				return PetStrengthRequest._parser;
			}
		}
		...
		private static readonly MessageParser<PetStrengthRequest> _parser = new MessageParser<PetStrengthRequest>(() => new PetStrengthRequest());
