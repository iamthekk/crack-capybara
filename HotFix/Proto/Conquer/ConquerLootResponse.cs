...
{
	public sealed class ConquerLootResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<ConquerLootResponse> Parser
		{
			get
			{
				return ConquerLootResponse._parser;
			}
		}
		...
		private static readonly MessageParser<ConquerLootResponse> _parser = new MessageParser<ConquerLootResponse>(() => new ConquerLootResponse());
