...
{
	public sealed class ConquerLootRequest : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<ConquerLootRequest> Parser
		{
			get
			{
				return ConquerLootRequest._parser;
			}
		}
		...
		private static readonly MessageParser<ConquerLootRequest> _parser = new MessageParser<ConquerLootRequest>(() => new ConquerLootRequest());
