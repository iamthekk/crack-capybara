...
{
	public sealed class MountDressResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<MountDressResponse> Parser
		{
			get
			{
				return MountDressResponse._parser;
			}
		}
		...
		private static readonly MessageParser<MountDressResponse> _parser = new MessageParser<MountDressResponse>(() => new MountDressResponse());
