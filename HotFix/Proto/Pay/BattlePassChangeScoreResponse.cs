...
namespace Proto.Pay
{
	public sealed class BattlePassChangeScoreResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<BattlePassChangeScoreResponse> Parser
		{
			get
			{
				return BattlePassChangeScoreResponse._parser;
			}
		}
		...
		private static readonly MessageParser<BattlePassChangeScoreResponse> _parser = new MessageParser<BattlePassChangeScoreResponse>(() => new BattlePassChangeScoreResponse());
