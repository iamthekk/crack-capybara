...
{
	public sealed class UnlockAvatarResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<UnlockAvatarResponse> Parser
		{
			get
			{
				return UnlockAvatarResponse._parser;
			}
		}
		...
		private static readonly MessageParser<UnlockAvatarResponse> _parser = new MessageParser<UnlockAvatarResponse>(() => new UnlockAvatarResponse());
