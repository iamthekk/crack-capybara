...
{
	public sealed class AccountSignInRequest : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<AccountSignInRequest> Parser
		{
			get
			{
				return AccountSignInRequest._parser;
			}
		}
		...
		private static readonly MessageParser<AccountSignInRequest> _parser = new MessageParser<AccountSignInRequest>(() => new AccountSignInRequest());
