...
{
	public sealed class GuildGetMessageRecordsRequest : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<GuildGetMessageRecordsRequest> Parser
		{
			get
			{
				return GuildGetMessageRecordsRequest._parser;
			}
		}
		...
		private static readonly MessageParser<GuildGetMessageRecordsRequest> _parser = new MessageParser<GuildGetMessageRecordsRequest>(() => new GuildGetMessageRecordsRequest());
