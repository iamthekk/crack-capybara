...
{
	public sealed class GuildDonationSendItemResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<GuildDonationSendItemResponse> Parser
		{
			get
			{
				return GuildDonationSendItemResponse._parser;
			}
		}
		...
		private static readonly MessageParser<GuildDonationSendItemResponse> _parser = new MessageParser<GuildDonationSendItemResponse>(() => new GuildDonationSendItemResponse());
