...
{
	public sealed class RPlayerDetailAttributeReq : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<RPlayerDetailAttributeReq> Parser
		{
			get
			{
				return RPlayerDetailAttributeReq._parser;
			}
		}
		...
		private static readonly MessageParser<RPlayerDetailAttributeReq> _parser = new MessageParser<RPlayerDetailAttributeReq>(() => new RPlayerDetailAttributeReq());
