...
{
	public sealed class GetMiningRewardResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<GetMiningRewardResponse> Parser
		{
			get
			{
				return GetMiningRewardResponse._parser;
			}
		}
		...
		private static readonly MessageParser<GetMiningRewardResponse> _parser = new MessageParser<GetMiningRewardResponse>(() => new GetMiningRewardResponse());
