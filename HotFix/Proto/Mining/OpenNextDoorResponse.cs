...
{
	public sealed class OpenNextDoorResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<OpenNextDoorResponse> Parser
		{
			get
			{
				return OpenNextDoorResponse._parser;
			}
		}
		...
		private static readonly MessageParser<OpenNextDoorResponse> _parser = new MessageParser<OpenNextDoorResponse>(() => new OpenNextDoorResponse());
