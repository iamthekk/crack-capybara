...
{
	public sealed class TowerRankDto : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<TowerRankDto> Parser
		{
			get
			{
				return TowerRankDto._parser;
			}
		}
		...
		private static readonly MessageParser<TowerRankDto> _parser = new MessageParser<TowerRankDto>(() => new TowerRankDto());
