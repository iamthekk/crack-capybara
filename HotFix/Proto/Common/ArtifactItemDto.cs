...
{
	public sealed class ArtifactItemDto : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<ArtifactItemDto> Parser
		{
			get
			{
				return ArtifactItemDto._parser;
			}
		}
		...
		private static readonly MessageParser<ArtifactItemDto> _parser = new MessageParser<ArtifactItemDto>(() => new ArtifactItemDto());
