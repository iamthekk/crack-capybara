...
{
	public sealed class ChapterWheelScoreRequest : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<ChapterWheelScoreRequest> Parser
		{
			get
			{
				return ChapterWheelScoreRequest._parser;
			}
		}
		...
		private static readonly MessageParser<ChapterWheelScoreRequest> _parser = new MessageParser<ChapterWheelScoreRequest>(() => new ChapterWheelScoreRequest());
