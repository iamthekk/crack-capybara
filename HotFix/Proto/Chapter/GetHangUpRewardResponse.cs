...
{
	public sealed class GetHangUpRewardResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<GetHangUpRewardResponse> Parser
		{
			get
			{
				return GetHangUpRewardResponse._parser;
			}
		}
		...
		private static readonly MessageParser<GetHangUpRewardResponse> _parser = new MessageParser<GetHangUpRewardResponse>(() => new GetHangUpRewardResponse());
