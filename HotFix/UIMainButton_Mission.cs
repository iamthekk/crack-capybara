...
namespace HotFix
{
	public class UIMainButton_Mission : BaseUIMainButton
	{
		public override bool IsShow()
		{
			return Singleton<GameFunctionController>.Instance.IsFunctionOpened(FunctionID.Task, false);
		}
		...
		protected override void OnInit()
		{
			...
			RedPointController.Instance.RegRecordChange("Main.Mission", new Action<RedNodeListenData>(this.OnRedPointChange));
		}

		protected override void OnDeInit()
		{
			RedPointController.Instance.UnRegRecordChange("Main.Mission", new Action<RedNodeListenData>(this.OnRedPointChange));
		...
		private void OnClickButton()
		{
			if (!this.IsShow())
			{
				GameApp.View.ShowStringTip(Singleton<GameFunctionController>.Instance.GetLockTips(14));
				return;
			}
			GameApp.View.CloseView(ViewName.MoreExtensionViewModule, null);
			TaskViewModule.OpenData openData = new TaskViewModule.OpenData();
			openData.srcViewName = ViewName.MoreExtensionViewModule;
			GameApp.View.OpenView(ViewName.TaskViewModule, openData, 1, null, null);
		}
		...
		private void OnRefreshNameText()
		{
			...
			{
				this.m_nameTxt.text = Singleton<LanguageManager>.Instance.GetInfoByID("ui_more_task");
			}
		}
		...
		public const string REDPOINT_NAME = "Main.Mission";
	}
}
