...
namespace HotFix
{
	public class SlotMachineViewModuleLoader : BaseViewModuleLoader
	{
		public override async Task OnLoad(object data)
		{
			List<Task> list = new List<Task>();
			this.m_loadSpriteAtlas = new LoadPool<SpriteAtlas>();
			list.Add(this.m_loadSpriteAtlas.Load(GameApp.Table.GetAtlasPath(101)));
			list.Add(this.m_loadSpriteAtlas.Load(GameApp.Table.GetAtlasPath(114)));
