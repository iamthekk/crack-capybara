...
{
	public sealed class ShopFreeIAPItemRequest : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<ShopFreeIAPItemRequest> Parser
		{
			get
			{
				return ShopFreeIAPItemRequest._parser;
			}
		}
		...
		private static readonly MessageParser<ShopFreeIAPItemRequest> _parser = new MessageParser<ShopFreeIAPItemRequest>(() => new ShopFreeIAPItemRequest());
