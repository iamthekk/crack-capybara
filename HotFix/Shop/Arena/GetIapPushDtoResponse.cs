...
{
	public sealed class GetIapPushDtoResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<GetIapPushDtoResponse> Parser
		{
			get
			{
				return GetIapPushDtoResponse._parser;
			}
		}
		...
		private static readonly MessageParser<GetIapPushDtoResponse> _parser = new MessageParser<GetIapPushDtoResponse>(() => new GetIapPushDtoResponse());
