...
namespace HotFix
{
	public class HoverLessHpBigSkill : BaseHover
	{
		public override HoverType GetHoverType()
		{
			return HoverType.LessHpBigSkill;
		}
		...
		protected override void OnInit()
		{
			...
			this.count = Utility.Math.Abs(hoverLongData.param);
			this.Show();
			this.isInit = true;
		}
		...
		private void Show()
		{
			char[] array = DxxTools.FormatNumber(this.count).ToCharArray();
