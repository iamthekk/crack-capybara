...
namespace Server
{
	public class SMemberSubmodule_Silence : SMemberBaseSubmodule
	{
		public SMemberSubmodule_Silence(SMemberBase member)
			: base(member)
		{
		}
		...
		public void Play(SilenceData data)
		{
