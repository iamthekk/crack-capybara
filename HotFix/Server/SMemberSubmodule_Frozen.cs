...
namespace Server
{
	public class SMemberSubmodule_Frozen : SMemberBaseSubmodule
	{
		public SMemberSubmodule_Frozen(SMemberBase member)
			: base(member)
		{
		}
		...
		public void Play(FrozenData data)
		{
