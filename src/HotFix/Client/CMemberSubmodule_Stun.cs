...
{
	public class CMemberSubmodule_Stun : CMemberBaseSubmodule
	{
		public CMemberSubmodule_Stun(CMemberBase member, int commonTableID, MemberBodyPosType bodyPosType)
		...
		{
			this.m_owner.ShowTextHUD(EHoverTextType.Stun);
