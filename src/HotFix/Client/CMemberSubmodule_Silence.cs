...
{
	public class CMemberSubmodule_Silence : CMemberBaseSubmodule
	{
		public CMemberSubmodule_Silence(CMemberBase member, int commonTableID, MemberBodyPosType bodyPosType)
		...
		{
			this.m_owner.ShowTextHUD(EHoverTextType.Silence);
