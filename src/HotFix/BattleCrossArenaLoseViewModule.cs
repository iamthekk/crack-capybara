...
namespace HotFix
{
	public class BattleCrossArenaLoseViewModule : BaseViewModule
	{
		...
		{
			this.loseEffect.SetActiveSafe(false);
		...
		{
			float duration = this.spineLose.SkeletonData.FindAnimation("ShengLi_1").Duration;
			this.spineLose.AnimationState.SetAnimation(0, "ShiBai_1", false);
			yield return new WaitForSeconds(duration);
			this.loseEffect.SetActiveSafe(true);
