...
namespace HotFix
{
	public class BattleChapterState : State
	{
		...
		public override async void OnEnter()
		{
			...
			Singleton<GameEventController>.Instance.EnterEventMode(GameEventStateName.Chapter);
			...
			await GameApp.View.OpenViewTask(ViewName.GameEventViewModule, null, 1, null, null);
			this.m_battleController = new BattleController_Chapter();
		...
		{
			BattleController_Chapter battleController = this.m_battleController;
		...
		private BattleController_Chapter m_battleController;
	}
}
