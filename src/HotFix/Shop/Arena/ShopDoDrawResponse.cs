...
{
	public sealed class ShopDoDrawResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<ShopDoDrawResponse> Parser
		{
			get
			{
				return ShopDoDrawResponse._parser;
			}
		}
		...
		public int CalculateSize()
		{
			...
			if (this.ShopSupCount != 0)
			{
				num += 1 + CodedOutputStream.ComputeInt32Size(this.ShopSupCount);
			}
			return num;
		}
		...
		private static readonly MessageParser<ShopDoDrawResponse> _parser = new MessageParser<ShopDoDrawResponse>(() => new ShopDoDrawResponse());
		...
		public const int ShopDrawDtoFieldNumber = 3;
		...
		public const int ShopSupCountFieldNumber = 5;
