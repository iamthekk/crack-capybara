...
namespace HotFix
{
	public class UIMainButton_Setting : BaseUIMainButton
	{
		public override bool IsShow()
		{
			return Singleton<GameFunctionController>.Instance.IsFunctionOpened(FunctionID.Setting, false);
		}
		...
		protected override void OnInit()
		{
			...
			RedPointController.Instance.RegRecordChange("Main.Setting", new Action<RedNodeListenData>(this.OnRedPointChange));
		}

		protected override void OnDeInit()
		{
			RedPointController.Instance.UnRegRecordChange("Main.Setting", new Action<RedNodeListenData>(this.OnRedPointChange));
		...
		public void OnClickButton()
		{
			if (!this.IsShow())
			{
				GameApp.View.ShowStringTip(Singleton<GameFunctionController>.Instance.GetLockTips(17));
				return;
			}
			GameApp.View.CloseView(ViewName.MoreExtensionViewModule, null);
			GameApp.View.OpenView(ViewName.SettingViewModule, null, 1, null, null);
		}
		...
		private void OnRefreshNameText()
		{
			...
			{
				this.m_nameTxt.text = Singleton<LanguageManager>.Instance.GetInfoByID("ui_more_setting");
			}
		}
		...
		public const string REDPOINT_NAME = "Main.Setting";
	}
}
