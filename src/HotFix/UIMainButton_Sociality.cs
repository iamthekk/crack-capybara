...
namespace HotFix
{
	public class UIMainButton_Sociality : BaseUIMainButton
	{
		public override bool IsShow()
		{
			return Singleton<GameFunctionController>.Instance.IsFunctionOpened(FunctionID.Friend, false);
		}
		...
		private void OnRefreshNameText()
		{
			...
			{
				this.m_nameTxt.text = Singleton<LanguageManager>.Instance.GetInfoByID("ui_more_friends");
			}
		}
		...
		public const string REDPOINT_NAME = "Main.Sociality";
	}
}
