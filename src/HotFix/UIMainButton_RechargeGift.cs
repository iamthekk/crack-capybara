...
namespace HotFix
{
	public class UIMainButton_RechargeGift : BaseUIMainButton
	{
		public override bool IsShow()
		{
			return Singleton<GameFunctionController>.Instance.IsFunctionOpened(FunctionID.RechargeGift, false);
		}
		...
		protected override void OnInit()
		{
			...
			RedPointController.Instance.RegRecordChange("IAPRechargeGift", new Action<RedNodeListenData>(this.OnRedPointChange));
		}

		protected override void OnDeInit()
		{
			RedPointController.Instance.UnRegRecordChange("IAPRechargeGift", new Action<RedNodeListenData>(this.OnRedPointChange));
		...
		{
			GameApp.View.OpenView(ViewName.IAPRechargeGiftViewModule, null, 1, null, null);
		}
		...
		private void OnRefreshNameText()
		{
			...
			{
				this.m_nameTxt.text = Singleton<LanguageManager>.Instance.GetInfoByID("uirechargegift_tag_fund");
			}
		}
		...
		public const string REDPOINT_NAME = "IAPRechargeGift";
	}
}
