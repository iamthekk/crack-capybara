...
namespace Server
{
	public class HurtFireAttack : HurtBase
	{
		...
		protected override void OnMathSkillDamageFix()
		{
			...
			FP fireDamageAdd = base.GetFireDamageAdd();
			FP skillTypeDamageAdd = base.GetSkillTypeDamageAdd();
			FP fp = FP._1 + damageAdd + otherDamageAdd + stateDamageAdd + petDamageAdd + fireDamageAdd + skillTypeDamageAdd;
