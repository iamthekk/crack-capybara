...
namespace Server
{
	public class SkillSelectPointOrderDescending : ISkillSelect
	{
		public void MathSelectTarget(SkillTriggerData triggerData, Dictionary<int, SMemberBase> allMembers, SMemberBase owner, SSkillBase skill, ref List<SMemberBase> targetMembers)
		{
			...
			targetMembers = targetMembers.OrderByDescending((SMemberBase c) => c.memberData.PosIndex).ToList<SMemberBase>();
		}
	}
}
