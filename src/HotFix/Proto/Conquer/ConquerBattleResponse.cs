...
{
	public sealed class ConquerBattleResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<ConquerBattleResponse> Parser
		{
			get
			{
				return ConquerBattleResponse._parser;
			}
		}
		...
		private static readonly MessageParser<ConquerBattleResponse> _parser = new MessageParser<ConquerBattleResponse>(() => new ConquerBattleResponse());
