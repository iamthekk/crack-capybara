...
{
	public sealed class ConquerBattleRequest : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<ConquerBattleRequest> Parser
		{
			get
			{
				return ConquerBattleRequest._parser;
			}
		}
		...
		private static readonly MessageParser<ConquerBattleRequest> _parser = new MessageParser<ConquerBattleRequest>(() => new ConquerBattleRequest());
