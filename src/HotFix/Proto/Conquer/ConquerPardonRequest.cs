...
{
	public sealed class ConquerPardonRequest : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<ConquerPardonRequest> Parser
		{
			get
			{
				return ConquerPardonRequest._parser;
			}
		}
		...
		private static readonly MessageParser<ConquerPardonRequest> _parser = new MessageParser<ConquerPardonRequest>(() => new ConquerPardonRequest());
