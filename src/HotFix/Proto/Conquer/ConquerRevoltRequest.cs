...
{
	public sealed class ConquerRevoltRequest : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<ConquerRevoltRequest> Parser
		{
			get
			{
				return ConquerRevoltRequest._parser;
			}
		}
		...
		private static readonly MessageParser<ConquerRevoltRequest> _parser = new MessageParser<ConquerRevoltRequest>(() => new ConquerRevoltRequest());
