...
{
	public sealed class MissionReceiveHangUpItemsResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<MissionReceiveHangUpItemsResponse> Parser
		{
			get
			{
				return MissionReceiveHangUpItemsResponse._parser;
			}
		}
		...
		private static readonly MessageParser<MissionReceiveHangUpItemsResponse> _parser = new MessageParser<MissionReceiveHangUpItemsResponse>(() => new MissionReceiveHangUpItemsResponse());
