...
{
	public sealed class MissionQuickHangUpResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<MissionQuickHangUpResponse> Parser
		{
			get
			{
				return MissionQuickHangUpResponse._parser;
			}
		}
		...
		private static readonly MessageParser<MissionQuickHangUpResponse> _parser = new MessageParser<MissionQuickHangUpResponse>(() => new MissionQuickHangUpResponse());
