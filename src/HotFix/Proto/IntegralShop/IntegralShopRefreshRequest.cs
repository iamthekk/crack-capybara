...
{
	public sealed class IntegralShopRefreshRequest : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<IntegralShopRefreshRequest> Parser
		{
			get
			{
				return IntegralShopRefreshRequest._parser;
			}
		}
		...
		private static readonly MessageParser<IntegralShopRefreshRequest> _parser = new MessageParser<IntegralShopRefreshRequest>(() => new IntegralShopRefreshRequest());
