...
{
	public sealed class UnlockUserAvatarResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<UnlockUserAvatarResponse> Parser
		{
			get
			{
				return UnlockUserAvatarResponse._parser;
			}
		}
		...
		private static readonly MessageParser<UnlockUserAvatarResponse> _parser = new MessageParser<UnlockUserAvatarResponse>(() => new UnlockUserAvatarResponse());
