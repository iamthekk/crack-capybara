...
{
	public sealed class UserUpdateInfoResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<UserUpdateInfoResponse> Parser
		{
			get
			{
				return UserUpdateInfoResponse._parser;
			}
		}
		...
		private static readonly MessageParser<UserUpdateInfoResponse> _parser = new MessageParser<UserUpdateInfoResponse>(() => new UserUpdateInfoResponse());
