...
{
	public sealed class UpdateUserAvatarResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<UpdateUserAvatarResponse> Parser
		{
			get
			{
				return UpdateUserAvatarResponse._parser;
			}
		}
		...
		private static readonly MessageParser<UpdateUserAvatarResponse> _parser = new MessageParser<UpdateUserAvatarResponse>(() => new UpdateUserAvatarResponse());
