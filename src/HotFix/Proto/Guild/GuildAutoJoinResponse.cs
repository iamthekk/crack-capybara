...
{
	public sealed class GuildAutoJoinResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<GuildAutoJoinResponse> Parser
		{
			get
			{
				return GuildAutoJoinResponse._parser;
			}
		}
		...
		private static readonly MessageParser<GuildAutoJoinResponse> _parser = new MessageParser<GuildAutoJoinResponse>(() => new GuildAutoJoinResponse());
