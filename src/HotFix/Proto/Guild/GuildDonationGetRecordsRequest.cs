...
{
	public sealed class GuildDonationGetRecordsRequest : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<GuildDonationGetRecordsRequest> Parser
		{
			get
			{
				return GuildDonationGetRecordsRequest._parser;
			}
		}
		...
		private static readonly MessageParser<GuildDonationGetRecordsRequest> _parser = new MessageParser<GuildDonationGetRecordsRequest>(() => new GuildDonationGetRecordsRequest());
