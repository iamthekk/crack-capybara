...
{
	public sealed class ArtifactApplySkillResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<ArtifactApplySkillResponse> Parser
		{
			get
			{
				return ArtifactApplySkillResponse._parser;
			}
		}
		...
		private static readonly MessageParser<ArtifactApplySkillResponse> _parser = new MessageParser<ArtifactApplySkillResponse>(() => new ArtifactApplySkillResponse());
