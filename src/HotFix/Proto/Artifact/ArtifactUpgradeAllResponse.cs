...
{
	public sealed class ArtifactUpgradeAllResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<ArtifactUpgradeAllResponse> Parser
		{
			get
			{
				return ArtifactUpgradeAllResponse._parser;
			}
		}
		...
		private static readonly MessageParser<ArtifactUpgradeAllResponse> _parser = new MessageParser<ArtifactUpgradeAllResponse>(() => new ArtifactUpgradeAllResponse());
