...
{
	public sealed class ChestUseRequest : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<ChestUseRequest> Parser
		{
			get
			{
				return ChestUseRequest._parser;
			}
		}
		...
		private static readonly MessageParser<ChestUseRequest> _parser = new MessageParser<ChestUseRequest>(() => new ChestUseRequest());
