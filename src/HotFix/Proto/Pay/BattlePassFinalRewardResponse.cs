...
namespace Proto.Pay
{
	public sealed class BattlePassFinalRewardResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<BattlePassFinalRewardResponse> Parser
		{
			get
			{
				return BattlePassFinalRewardResponse._parser;
			}
		}
		...
		private static readonly MessageParser<BattlePassFinalRewardResponse> _parser = new MessageParser<BattlePassFinalRewardResponse>(() => new BattlePassFinalRewardResponse());
