...
{
	public sealed class PushMessageDto : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<PushMessageDto> Parser
		{
			get
			{
				return PushMessageDto._parser;
			}
		}
		...
		private static readonly MessageParser<PushMessageDto> _parser = new MessageParser<PushMessageDto>(() => new PushMessageDto());
