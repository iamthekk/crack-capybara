...
namespace Proto.Pet
{
	public sealed class PetTrainSureResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<PetTrainSureResponse> Parser
		{
			get
			{
				return PetTrainSureResponse._parser;
			}
		}
		...
		private static readonly MessageParser<PetTrainSureResponse> _parser = new MessageParser<PetTrainSureResponse>(() => new PetTrainSureResponse());
