...
{
	public sealed class MountUpgradeAllResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<MountUpgradeAllResponse> Parser
		{
			get
			{
				return MountUpgradeAllResponse._parser;
			}
		}
		...
		private static readonly MessageParser<MountUpgradeAllResponse> _parser = new MessageParser<MountUpgradeAllResponse>(() => new MountUpgradeAllResponse());
