...
{
	public sealed class MountApplySkillResponse : IMessage
	{
		[DebuggerNonUserCode]
		public static MessageParser<MountApplySkillResponse> Parser
		{
			get
			{
				return MountApplySkillResponse._parser;
			}
		}
		...
		private static readonly MessageParser<MountApplySkillResponse> _parser = new MessageParser<MountApplySkillResponse>(() => new MountApplySkillResponse());
