...
namespace HotFix
{
	public class GameEventViewModuleLoader : BaseViewModuleLoader
	{
		public override async Task OnLoad(object data)
		{
			...
			list2.Add(GameApp.Table.GetAtlasPath(103));
			list2.Add(GameApp.Table.GetAtlasPath(104));
			list2.Add(GameApp.Table.GetAtlasPath(121));
